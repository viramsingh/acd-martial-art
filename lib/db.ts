...
const DEFAULT_DB: DatabaseSchema = {
  students: [
    ...
    },
    {
      ...
      address: "Station Road, Mandsaur",
      guardianName: "Suresh Sharma",
      emergencyPhone: "9876543211",
      schoolName: "St. Thomas School Mandsaur",
      batch: "Evening 5:00 To 6:00",
      beltLevel: "White Belt",
      joiningDate: "2026-09-01",
      status: "ACTIVE",
  ...
  attendance: [
    {
      id: "ATT-1788265313798-5",
      date: "2026-09-01",
      studentId: "ACD-2026-004",
      studentName: "new",
      batch: "Evening 5:00 To 6:00",
      status: "PRESENT",
      checkInTime: "05:51 PM"
    },
    {
      id: "ATT-1788265254526-748",
      date: "2026-09-01",
      studentId: "ACD-2026-003",
      studentName: "kamal",
      batch: "Evening 5:00 To 6:00",
      status: "ABSENT"
    },
    {
      id: "ATT-1788265081122-626",
      date: "2026-09-01",
      studentId: "ACD-2026-002",
      studentName: "viram singh",
      batch: "Evening 5:00 To 6:00",
      status: "PRESENT",
      checkInTime: "05:51 PM"
    },
    {
      id: "ATT-1788264980648-202",
      date: "2026-09-01",
      studentId: "ACD-2026-001",
